...
- Direzione antenna: schermata dedicata con azimut e bussola del dispositivo; un collegamento apre il centro del locator remoto nell’app Maps. Il pulsante Telegram apre `https://t.me/IQ1TObot?startapp=bearing_SPOT_ID`; dalla bussola si può aprire direttamente il QSL dello stesso SPOT.
...
- La Mini App registra un service worker per velocizzare il caricamento e mantenere disponibili gli asset già visitati. Le API e la pubblicazione richiedono connessione.
...
La lista delle bande è in `public/radio.js`: LF, MF, HF, 6/2 m e UHF fino a 0,13 m, con frequenze intere in Hz nel database. La whitelist operativa usa il PNRF MIMIT italiano: 160 m limitata a 1830–1850 kHz, 70 cm a 430–434 / 435–438 MHz, 23 cm a 1240–1245 / 1270–1298 MHz e 4 m esclusa dagli SPOT ordinari perché non stabilmente attribuita al servizio di radioamatore (salvo sperimentazioni/autorizzazioni MIMIT vigenti). La scheda “Band plan” mostra anche Note PNRF e sottobande/modi orientativi IARU Region 1. Le lacune nazionali sono escluse anche dalla validazione server e dal frequenziometro; 1267–1270 MHz è documentata come eccezione satellitare Terra→spazio (nota 117), non abilitata per SPOT ordinari. Fonti, edizioni e limiti del controllo sono in [docs/bandplan-audit.md](docs/bandplan-audit.md). Non è comunque una verifica della licenza individuale, della potenza, della larghezza di banda, delle condizioni locali o delle autorizzazioni temporanee. Le bande non comprese si aggiungono nello stesso file condiviso da server e browser. Nominativo e posizione sono dichiarati dall’utente: l’app verifica il formato, non l’effettivo possesso del nominativo o l’autenticità del GPS.
